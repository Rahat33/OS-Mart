                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="{{URL::to($v_product->product_image)}}" alt="" / style="height: 200px">
                                            <h2>{{$v_product->price}}TK</h2>
                                ...
                                <div class="choose">
                                    <ul class="nav nav-pills nav-justified">
                                        <li><a href="#"><i class="fa fa-plus-square"></i>{{$v_product->category_name}}</a></li>
                                        <li><a href="{{URL::to('/view_product/'.$v_product->product_id)}}"><i class="fa fa-plus-square"></i>View</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
