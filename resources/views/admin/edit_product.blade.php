			...
			enctype="multipart/form-data">
			  ...
			  <fieldset>
                ...
                <div class="control-group">
				  ...
				  <div class="control-group">
                    ...
                    <?php
                      ...
                      $publish_manufacture = DB::table('tbl_manufacture')
                                	->where('publication_status',1)
                                    ->get();
                      foreach ($publish_manufacture as $v_manufacture) {?>
				...
				<div class="control-group">
				  ...
				  <div class="controls">
					<input type="text" class="input-xlarge" name="price" value="{{$product_info->price}}">
				  </div>
				</div>
                <div class="control-group">
				...
				<div class="control-group">
				  ...
				  <div class="controls">
					<input type="text" class="input-xlarge" name="product_colore" value="{{$product_info->product_colore}}">
				  </div>
				</div>
