...
class ProductController extends Controller
{
    ...
    public function edit_product($product_id){
    	$product_info=DB::table('tbl_products')
                        ->leftJoin('tbl_category','tbl_products.category_id','=','tbl_category.category_id')
                        ->leftJoin('tbl_manufacture','tbl_products.manufacture_id','=','tbl_manufacture.manufacture_id')
                        ->select('tbl_products.*','tbl_category.*','tbl_manufacture.*')
    ...
    public function update_product(Request $request, $product_id){
        ...
        $data=array();
         ...
         $data['product_colore']=$request->product_colore;
    ...
    public function unactive_product($product_id){
    	...
    	DB::table('tbl_products')
    		...
    		Session::put('message','Unactive Product Cuccessfully......!!!!');
    		return Redirect::to('/all-product');
    }
    ...
    public function active_product($product_id){
    	DB::table('tbl_products')
    		...
    		Session::put('message','Active Product Cuccessfully......!!!!');
    		return Redirect::to('/all-product');
    }
    ...
    public function save_product(Request $request){
    	...
    	$data=array();
    		...
    		$data['product_image']='';
    		DB::table('tbl_products')->insert($data);
    		Session::put('massage','product add!!!');
    		return Redirect::to('/add-product');
    }
